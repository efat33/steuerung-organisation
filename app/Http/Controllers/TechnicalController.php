...
class TechnicalController extends Controller
{
    ...
    public function update(TechniclOfferRequest $request, TechnicalOffer $technicalOffer)
    {
        ...
        $technicalOffer->received_date = Carbon::parse($request->received_date)->format('Y-m-d');
        ...
        $technicalOffer->offer_date = Carbon::parse($request->offer_date)->format('Y-m-d');
        $technicalOffer->offer_amount = $request->offer_amount;
        $technicalOffer->offer_follow_up = Carbon::parse($request->offer_follow_up)->format('Y-m-d');
        $technicalOffer->conversation_status = $request->conversation_status;
        $technicalOffer->order_number = $request->order_number;
        $technicalOffer->order_date = Carbon::parse($request->order_date)->format('Y-m-d');
        $technicalOffer->order_amount = $request->order_amount;
        $technicalOffer->execution_date = Carbon::parse($request->execution_date)->format('Y-m-d');
        $technicalOffer->approval_date = Carbon::parse($request->approval_date)->format('Y-m-d');
