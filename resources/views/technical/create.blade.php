                        ...
                        <form method='POST' action="<?= route('technical.store') ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-select-box.select-box name="get_over" title="Select Option">
                                        ...
                                        <option value="{{ $item }}" {{ old('get_over') == $item ? "selected" : "" }} >{{ App\Enums\GetOver::getLabel($item ) }}</option>
                                        @endforeach
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-inputs.text id="cs_order_number" type="text" name="cs_order_number" value="{{ old('cs_order_number') }}"
                                         />
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-inputs.text id="received_date" type="text" name="received_date" value="{{ old('received_date') }}" placeholder="Wähle einen Dake" />
                                    <x-inputs.error :messages="$errors->get('received_date')" />
                                </div>

                                <div class="mb-3 col-md-6">
                                    <x-inputs.label for="received_from" value="Erhalten Von" />
                                    <x-inputs.text id="received_from" type="text" name="received_from" value="{{ old('received_from') }}" />
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-inputs.text id="customer_number" type="text" name="customer_number" value="{{ old('customer_number') }}" />
                                    <x-inputs.error :messages="$errors->get('customer_number')" />
                                </div>

                                <div class="mb-3 col-md-6">
                                    <x-inputs.label for="technical_place" value="Technischer Platz" />
                                    <x-inputs.text id="technical_place" type="text" name="technical_place" value="{{ old('technical_place') }}" />
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-inputs.textarea id="technical_place_address" type="text" name="technical_place_address" value="{{ old('technical_place_address') }}" />
                                    <x-inputs.error :messages="$errors->get('technical_place_address')" />
                                </div>

                                <div class="mb-3 col-md-6">
                                    <x-inputs.label for="technical_postcode" value="Postleitzahl" />
                                    <x-inputs.text id="technical_postcode" type="text" name="technical_postcode" value="{{ old('technical_postcode') }}" />
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-select-box.select-box name="status" title="Select Option">
                                        ...
                                        <option value="{{ $item }}" {{ old('status') == $item ? "selected" : "" }} >{{ App\Enums\Status::getLabel($item ) }}</option>
                                        @endforeach
                                    </x-select-box.select-box>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-select-box.select-box name="offer_type" title="Select Option">
                                        ...
                                        <option value="{{ $item }}" {{ old('offer_type') == $item ? "selected" : "" }} >{{ App\Enums\OfferType::getLabel($item ) }}</option>
                                        @endforeach
                                    </x-select-box.select-box>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-inputs.text id="ktb_number" type="text" name="ktb_number" value="{{ old('ktb_number') }}" />
                                    <x-inputs.error :messages="$errors->get('ktb_number')" />
                                </div>

                                <div class="mb-3 col-md-6">
                                    <x-inputs.label for="quote_number" value="Angebotsnummer" />
                                    <x-inputs.text id="quote_number" type="text" name="quote_number" value="{{ old('quote_number') }}" />
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-inputs.text id="offer_date" type="text" name="offer_date" value="{{ old('offer_date') }}" placeholder="Wähle einen Dake" />
                                    <x-inputs.error :messages="$errors->get('offer_date')" />
                                </div>

                                <div class="mb-3 col-md-6">
                                    <x-inputs.label for="offer_amount" value="Angebotssumme" />
                                    <x-inputs.text id="offer_amount" type="text" name="offer_amount" value="{{ old('offer_amount') }}" />
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-inputs.text id="offer_follow_up" type="text" name="offer_follow_up" value="{{ old('offer_follow_up') }}" placeholder="Wähle einen Dake" />
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-select-box.select-box name="conversation_status" title="Select Option">
                                        ...
                                        <option value="{{ $item }}" {{ old('conversation_status') == $item ? "selected" : "" }} >{{ App\Enums\ConversationStatus::getLabel($item ) }}</option>
                                        @endforeach
                                    </x-select-box.select-box>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-inputs.text id="order_number" type="text" name="order_number" value="{{ old('order_number') }}" />
                                    <x-inputs.error :messages="$errors->get('order_number')" />
                                </div>

                                <div class="mb-3 col-md-6">
                                    <x-inputs.label for="order_date" value="Auftragsdatum" />
                                    <x-inputs.text id="order_date" type="text" name="order_date" value="{{ old('order_date') }}" placeholder="Wähle einen Dake" />
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-inputs.text id="order_amount" type="text" name="order_amount" value="{{ old('order_amount') }}" />
                                    <x-inputs.error :messages="$errors->get('order_amount')" />
                                </div>

                                <div class="mb-3 col-md-6">
                                    <x-inputs.label for="execution_date" value="Durchführungsdatum" />
                                    <x-inputs.text id="execution_date" type="text" name="execution_date" value="{{ old('execution_date') }}" placeholder="Wähle einen Dake" />
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-inputs.text id="approval_date" type="text" name="approval_date" value="{{ old('approval_date') }}" placeholder="Wähle einen Dake" />
                                    <x-inputs.error :messages="$errors->get('approval_date')" />
                                </div>

                                <div class="mb-3 col-md-6">
                                    <x-inputs.label for="invice_amount" value="Fakturawert" />
                                    <x-inputs.text id="invice_amount" type="text" name="invice_amount" value="{{ old('invice_amount') }}" />
