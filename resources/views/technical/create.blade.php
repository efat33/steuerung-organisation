            ...
            <div class="card card-body mx-3 mx-md-3 mt-4">
                <div class="card card-plain h-100">
                    <div class="card-body p-3">
                        ...
                        <form method='POST' action="<?= route('technical.store') ?>" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="grid-parent mb-4">
                                ...
                                <div class="grid-item">
                                    ...
                                    <x-select-box.select-box name="registered_by" title="Select Option">
                                        ...
                                        <option value="{{ $item->id }}" {{ old('registered_by')==$item->id ? "selected" : "" }}>{{
                                            $item->name }}</option>
                                        @endforeach
                                    </x-select-box.select-box>
                                ...
                                <div class="grid-item">
                                    ...
                                    <x-select-box.select-box name="civil_technical_acceptance" title="Select Option">
                                        ...
                                        <option value="{{ $item }}" {{ old('civil_technical_acceptance')==$item ? "selected"
